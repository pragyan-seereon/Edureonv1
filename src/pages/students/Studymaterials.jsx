  ...
  const visible = useMemo(
    () =>
      materials.filter(
        (m) =>
          !m.archived &&
          m.klasses.includes(STUDENT_CLASS) &&
          (sub === "all" || m.subject === sub) &&
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description={`Resources mapped to class ${STUDENT_CLASS}`}
      />
        ...
        <CardContent className="p-0 divide-y">
          ...
          {visible.length === 0 && (
            <div className="text-sm text-muted-foreground text-center p-6">
              No materials yet for your class.
            </div>
          )}
        </CardContent>
      </Card>

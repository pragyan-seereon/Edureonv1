        ...
        actions={
          <>
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                toast.info("Open Edit dialog from the Classes page → row menu")
              }
            >
            ...
            <Button
              ...
              size="sm"
              onClick={() => {
                sectionsApi.archive(sec.id, !sec.archived);
                toast.success(sec.archived ? "Restored" : "Archived");
              }}
            >
              <Archive className="h-4 w-4" />
              {sec.archived ? "Restore" : "Archive"}
            </Button>
            <Button
              variant="destructive"
              size="sm"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <Card className="border-border/60">
          <CardContent className="p-4">
            ...
            <div className="text-2xl font-semibold mt-1">{secMaps.length}</div>
          </CardContent>
        </Card>
        <Card className="border-border/60">
          <CardContent className="p-4">
            <div className="text-xs text-muted-foreground">Avg attendance</div>
            <div className="text-2xl font-semibold mt-1 text-success">92%</div>
          </CardContent>
        </Card>
        <Card className="border-border/60">
          <CardContent className="p-4">
            <div className="text-xs text-muted-foreground">Term avg</div>
      ...
      <Tabs defaultValue="students">
                ...
                <TableBody>
                  {secStudents.length === 0 && (
                    <TableRow>
                      ...
                      >
                        No students mapped to {sec.name}
                      </TableCell>
                    </TableRow>
                  )}
                  {secStudents.map((s) => (
                  ...
                  {secMaps.length === 0 && (
                    <TableRow>
                      <TableCell
                        ...
                        className="text-center text-muted-foreground py-8"
                      >
                        No subjects mapped — go to Classes › Subject Mapping
                      </TableCell>
                    </TableRow>
                  )}
                  {secMaps.map((m) => {
          ...
          <Card className="border-border/60">
            <CardContent className="p-6 text-center">
              ...
              <CardDescription className="mb-4">
                Edit, swap, lock, clone and publish in the Timetable Engine.
              </CardDescription>
            ...
            <CardContent className="p-6 text-sm">
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <CardDescription>
                    Assignments mapped to this section
                  </CardDescription>
                </div>
              ...
              <div className="text-muted-foreground">
                Assignments linkage flows from the Assignments module.
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="border-border/60">
            <CardContent className="p-6">
              ...
              <div className="mt-3 text-xs text-muted-foreground">
                Daily attendance heatmap — last 35 school days
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="border-border/60">
            <CardContent className="p-0">
              <Table>
                ...
                <TableBody>
                  {["Unit Test 1", "Mid Term", "Unit Test 2", "Pre-Board"].map(
                    (e, i) => (
                      <TableRow key={e}>
                        <TableCell className="font-medium">{e}</TableCell>
                        <TableCell>{72 + i * 2}%</TableCell>
                        <TableCell>{91 + i}%</TableCell>
        ...
        <TabsContent value="analytics" className="mt-4">
          <div className="grid md:grid-cols-3 gap-3">
            {[
              { l: "Top performers", v: "7 students", t: "success" },
              { l: "At-risk", v: "3 students", t: "warning" },
              { l: "Subject leader", v: "Mathematics", t: "info" },
            ].map((k) => (
        ...
        <TabsContent value="docs" className="mt-4">
          <Card className="border-border/60">
            <CardContent className="p-6 text-sm space-y-2">
              {[
                "Section attendance register.pdf",
                "Class photo 2025.jpg",
                "Parent meeting minutes Q2.pdf",
              ].map((d) => (
                <div
                  key={d}

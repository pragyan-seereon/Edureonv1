        ...
        <TabsContent value="institute">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Public information displayed on receipts, certificates and
                notices.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button
                  ...
                  onClick={() => {
                    updateProfile({ institute: profile.institute });
        ...
        <TabsContent value="branding">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Customize the look across web, mobile and parent portal.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-5">
              ...
              <Field label="Logo">
                <div className="border-2 border-dashed border-border rounded-lg p-6 text-center text-sm text-muted-foreground">
                  Drop a PNG or SVG · max 2 MB · transparent background
                  recommended
                </div>
              </Field>
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div>
                  <div className="text-sm font-medium">
                    Remove Scholaris badge
                  </div>
                  <div className="text-xs text-muted-foreground">
                    White-label everything for parents and students.
                  </div>
                </div>
        ...
        <TabsContent value="localization">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Language, region, time zone and currency for your institute.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="security">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Enforce institute-wide security controls.
              </CardDescription>
            </CardHeader>
            <CardContent className="divide-y divide-border/60">
              {[
                {
                  k: "enforce2FA",
                  label: "Enforce 2FA for staff",
                  desc: "All employees must enable two-factor authentication.",
                },
                {
                  k: "ipAllowlist",
                  label: "IP allowlist",
                  desc: "Restrict admin access to specific networks.",
                },
                {
                  k: "sso",
                  label: "Single Sign-On (SAML)",
                  desc: "Allow login through Google Workspace or Microsoft Entra.",
                },
                {
                  k: "passwordExpiry",
                  label: "Password rotation (90 days)",
                  desc: "Force password change quarterly.",
                },
              ].map((row) => (
                <div
                  key={row.k}
                ...
                >
                  ...
                  <Switch
                    checked={security[row.k]}
                    onCheckedChange={(v) =>
                      setSecurity({ ...security, [row.k]: v })
                    }
                  />
                </div>
              ))}
        ...
        <TabsContent value="integrations">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Connect Scholaris with your existing stack.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid sm:grid-cols-2 gap-3">
              {[
                {
                  name: "Razorpay",
                  desc: "Online fee collection",
                  icon: CreditCard,
                  on: true,
                },
                {
                  name: "Google Workspace",
                  desc: "Meet, Calendar, Drive",
                  icon: Mail,
                  on: true,
                },
                {
                  name: "Zoom",
                  desc: "Live classes & meetings",
                  icon: Zap,
                  on: false,
                },
                {
                  name: "WhatsApp Business",
                  desc: "Notifications & broadcasts",
                  icon: Mail,
                  on: true,
                },
                {
                  name: "Microsoft 365",
                  desc: "Teams, Outlook, OneDrive",
                  icon: Mail,
                  on: false,
                },
                {
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium flex items-center gap-2">
                      ...
                      {it.on && (
                        <Badge
                          variant="outline"
                          className="bg-success/10 text-success border-success/20 text-[9px]"
                        >
                  ...
                  <Button
                    size="sm"
                    variant={it.on ? "outline" : "default"}
                    className={it.on ? "" : "gradient-primary border-0"}
                    onClick={() =>
                      toast.success(it.on ? "Disconnected" : "Connected")
                    }
                  >
        ...
        <TabsContent value="backups">
          <Card className="border-border/60">
            <CardHeader>
              ...
              <CardDescription>
                Daily encrypted snapshots stored across multiple regions.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-2.5 rounded-md hover:bg-muted/50 text-sm"
                  >
                    <span>{b.d}</span>
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => toast.success("Restore queued")}
                    >
                      Restore
                    </Button>
                  </div>

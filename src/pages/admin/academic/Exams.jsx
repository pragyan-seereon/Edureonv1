...
export default function Exams() {
  ...
  const setMark = (sid, subject, value) => {
    setResultRows((p) => ({
      ...p,
                  ...
                  {solutions.map((s) => (
                    <TableRow key={s.id}>
                      ...
                      <TableCell className="text-xs">
                        <FileCheck2 className="h-3.5 w-3.5 inline mr-1 text-success" />
                        {s.fileName}
                      </TableCell>
                      <TableCell>
                        <Button
                ...
                <Table>
                  ...
                  <TableBody>
                    {resStudents.length === 0 && (
                      <TableRow>
                        <TableCell colSpan={4 + resSubjects.length} className="text-center text-sm text-muted-foreground py-8">
                          No students in Class {resClass}-{resSection}.
                        </TableCell>
                      </TableRow>
                    )}
                    {resSubjects.length === 0 && resStudents.length > 0 && (
                      <TableRow>
                        <TableCell colSpan={6} className="text-center text-sm text-muted-foreground py-8">
                          Add subjects/papers for {resCategory} · Class {resClass} first.
                        </TableCell>
                      </TableRow>
                    )}

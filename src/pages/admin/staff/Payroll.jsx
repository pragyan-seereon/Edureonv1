  ...
  return (
    <PageContainer>
        ...
        actions={
          <>
            <Button
              variant="outline"
              size="sm"
              onClick={() => toast.success("Bank file exported")}
            >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard
          label="Payslips"
          value={latest ? latest.employeeCount.toString() : "0"}
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={() => toast.success("Payslips emailed")}
                        >
                        ...
                        {r.status !== "Paid" && (
                          <DropdownMenuItem
                            onClick={() => {
                              payrollApi.update(r.id, {
                                status:
                                  r.status === "Draft" ? "Approved" : "Paid",
                              });
                              toast.success("Status advanced");
                            }}
                          >
                            <CheckCircle2 className="h-4 w-4" />
                            {r.status === "Draft" ? "Approve" : "Mark paid"}
                          </DropdownMenuItem>
                        )}
                        <DropdownMenuItem
                          onClick={() => toast.success("NEFT file generated")}
                        >
                          <Download className="h-4 w-4" />
                          NEFT file
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onClick={() =>
                            payrollApi.update(r.id, { status: "Draft" })
                          }
                        >

...
const catalog = [
  {
    title: "RD Sharma — Class X Mathematics",
    author: "R.D. Sharma",
    category: "Mathematics",
    available: 4,
  },
  {
    title: "Pradeep's Fundamental Physics",
    author: "K.L. Gomber",
    category: "Physics",
    available: 0,
  },
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        title="Library"
        description="My issued books, catalogue search, and reading history."
      />
        ...
        <TabsContent value="my">
          <Card className="border-border/60">
            <CardHeader className="pb-2">
              ...
              <CardDescription>{issued.length} books</CardDescription>
            </CardHeader>
                  ...
                  {results.map((c) => (
                    <TableRow key={c.title}>
                      ...
                      <TableCell className="text-right">
                        <Button
                          size="sm"
                          variant={c.available > 0 ? "outline" : "ghost"}
                          disabled={c.available === 0}
                          onClick={() => toast.success(`Reserved: ${c.title}`)}
                        >

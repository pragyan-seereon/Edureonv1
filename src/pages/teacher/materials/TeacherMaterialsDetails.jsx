...
export default function TeacherMaterialsDetails() {
  const { id } = useParams();
  useMaterials();
    ...
    return (
      <PageContainer>
        <div className="text-sm text-muted-foreground">
          Not found.{" "}
          <Link to="/teacher/materials" className="underline">
            Back
          </Link>
        </div>
      </PageContainer>
        ...
        actions={
          <>
            ...
            <Button
              ...
              variant="outline"
              onClick={() => {
                materialsApi.archive(m.id, !m.archived);
          ...
          <Card>
            <CardContent className="p-4 text-sm space-y-2">
              <div className="flex justify-between border-b py-2">
                ...
                <span className="font-mono text-xs">{m.url}</span>
              </div>
              <div className="flex justify-between border-b py-2">

  ...
  try {
    ...
    setClasses(
      Array.isArray(raw)
        ? raw
            .map((item) => ({
              class_uuid: item.class_uuid || item.uuid || item.id,
              class_name:
                item.class_name || item.name || item.class || String(item),
            }))
            .filter((item) => item.class_uuid)
        : []
    );
 ...
 const save = async () => {
  ...
  try {
    ...
    const payload = {
          ...
          due_day_of_month: Number(f.due_day_of_month || 0),
            ...
            <Input
              ...
              onBlur={() =>
                setF((prev) => ({
                  ...prev,
                  due_day_of_month:
                    prev.due_day_of_month === "" ||
                    prev.due_day_of_month == null
                      ? 1
                      : Number(prev.due_day_of_month),
                }))
              }
            />
          </Field>
          ...
          <Field label="Effective to (optional)">
            ...
            {f.effective_to && (
              <button
                ...
                onClick={() => setF((prev) => ({ ...prev, effective_to: "" }))}
              >
                Clear date
              </button>
            )}
            ...
            <Input
              ...
              onBlur={() =>
                setF((prev) => ({
                  ...prev,
                  late_fee_per_month:
                    prev.late_fee_per_month === "" ||
                    prev.late_fee_per_month == null
                      ? 0
                      : Number(prev.late_fee_per_month),
                }))
              }
            />
          </Field>
            ...
            <Input
              ...
              onBlur={() =>
                setF((prev) => ({
                  ...prev,
                  grace_days_after_due:
                    prev.grace_days_after_due === "" ||
                    prev.grace_days_after_due == null
                      ? 0
                      : Number(prev.grace_days_after_due),
                }))
              }
            />
          </Field>

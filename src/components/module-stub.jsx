...
export function ModuleStub({
  ...
  const defaultFields = fields ?? [
    { name: "title", label: "Title" },
    {
      ...
      label: "Type",
      type: "select",
      options: ["Standard", "Premium", "Critical"],
    },
  ...
  return (
    <PageContainer>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="font-display text-xl font-semibold mb-1">
                Module ready for action
              </h2>
              <p className="text-sm text-muted-foreground max-w-2xl">
                Use the workflows below — each opens an editable record. Connect
                Lovable Cloud to persist data across devices and enable RBAC +
                notifications.
              </p>
      ...
      <CrudDialog
        ...
        description={
          active
            ? `Configure ${active.toLowerCase()} for ${title}.`

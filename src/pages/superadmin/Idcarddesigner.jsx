...
// Route registration (add this in your router file, e.g. routes/admin/id-cards.jsx):
//   <Route path="/admin/id-cards" element={<IdCardPage />} />

const blank = { name: "", idNo: "", contact: "", meta: "", note: "", photo: "", logo: "" };

function useFile(set) {
  return (e) => {
...
function CardPreview({ d, kind }) {
  const session = "2025-26"; // TODO: replace with your real session/year source once confirmed
...
function UploadField({ label, onChange, has }) {
